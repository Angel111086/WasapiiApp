...
public class SentMeetRequestActivity extends AppCompatActivity {


    private Context ctx;
    private ImageAdapter mPageAdapter;
    Toolbar toolbar;
    private ImageView btn_chat, btn_meet, btn_reject;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_meet_request);
        ...
        ctx = SentMeetRequestActivity.this;

        userId = getIntent().getStringExtra("user id");
        Log.e("SentMeet",userId);
        ...
        btn_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra("SentMeetUserId",userId);
                startActivity(in);
            }
        });
...
//                        .show();
    ...
    private void parseResponse(String response){
        ...
        try {
            ...
            if(flag==1){
                ...
                mPageAdapter = new SentMeetRequestActivity.ImageAdapter();
    ...
    public void actionSendMeetRequest(final int type){
        if(!CommonUtilities.isOnline(ctx)){
            Toast.makeText(ctx,R.string.no_internet_connection,Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void parseResponseRequests(String response,int type){
        ...
        try {
            ...
            if(flag == 1){
                ...
                if(type==3){
                    Toast.makeText(ctx,"Meet Request Accepted",Toast.LENGTH_SHORT).show();


                }else{
                    Toast.makeText(ctx,"Meet Request Rejected",Toast.LENGTH_SHORT).show();
                }
            }else{
                Toast.makeText(ctx,errorMessage,Toast.LENGTH_SHORT).show();
            }
        ...
        try {
            ...
            JsonRequest jsonRequest =  new JsonObjectRequest(Request.Method.POST,url,parameters,new Response.Listener<JSONObject>(){
                ...
                public void onResponse(JSONObject response) {
                    ...
                    parseUserBlockResponse(response.toString());
    ...
    private void parseUserBlockResponse(String response){
        ...
        try {
            ...
            JsonRequest jsonRequest =  new JsonObjectRequest(Request.Method.POST,url,parameters,new Response.Listener<JSONObject>(){
                ...
                public void onResponse(JSONObject response) {
                    ...
                    parseUserReportResponse(response.toString());
    ...
    private void parseUserReportResponse(String response){
