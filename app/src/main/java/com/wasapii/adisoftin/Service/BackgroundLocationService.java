    ...
    public void onConnected(Bundle bundle) {
      ...
      Location  mLastLocation = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
        ...
        if (mLastLocation != null) {
            ...
            Log.d("wasapii","my current service lat="+String.valueOf(mLastLocation.getLatitude())+" lng="+String.valueOf(mLastLocation.getLongitude()));

        }else{
            Log.d("wasapii","****onConnected service null***");
        }
 ...
 */
    ...
    public class LocationReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Location location = (Location) intent.getExtras().get("location changed");//(LocationClient.KEY_LOCATION_CHANGED);
            Log.e("wasapii","LocationReceiver onReceive lat="+location.getLongitude()+" lng="+location.getLongitude());
